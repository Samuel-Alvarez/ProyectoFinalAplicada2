...
@Composable
fun ConsultaReportesScreen(navHostController: NavHostController, viewModel: ReportesViewModel = hiltViewModel()){
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    navHostController.navigate(Screen.RegistroProblema.route)
                },
            ) {
