...
@Composable
fun registroMecanicoNuevo(navHostController: NavHostController, viewModel: MecanicoViewModel = hiltViewModel()){

    Scaffold(
        topBar ={
            TopAppBar(title = { Text(text = "Registrar Nuevo Mecanico") },
            )
        },
